...
int main()
{
    ...
    else if (command == 2)
    {
        ...
        while (table_move_to_next_register(table))
        {
            ...
            printf("%d\n", *((int32_t*)get_data_in_collumn(current_data, table->format, 0)));
            printf("%d\n", *((int32_t*)get_data_in_collumn(current_data, table->format, 1)));
            printf("%s\n", (char*)get_data_in_collumn(current_data, table->format, 2));
            printf("%s\n", (char*)get_data_in_collumn(current_data, table->format, 3));
            printf("%s\n", (char*)get_data_in_collumn(current_data, table->format, 4));
            registers_read += 1;
        }
